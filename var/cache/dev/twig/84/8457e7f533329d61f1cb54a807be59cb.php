...
class __TwigTemplate_9e468418498018e8f298e4a666b9ad64 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 10
        yield Twig\Extension\CoreExtension::include($this->env, $context, "profile/_profile_header.html.twig");
        yield "
";
        // line 11
        yield Twig\Extension\CoreExtension::include($this->env, $context, "profile/_profile_tabs.html.twig");
        yield "
";
        // line 12
        yield Twig\Extension\CoreExtension::include($this->env, $context, "micro_post/_post_list.html.twig", ["posts" => (isset($context["posts"]) || array_key_exists("posts", $context) ? $context["posts"] : (function () { throw new RuntimeError('Variable "posts" does not exist.', 12, $this->source); })())]);
        yield "
";
    ...
    {
        return array (  121 => 12,  117 => 11,  113 => 10,  103 => 9,  91 => 6,  81 => 5,  61 => 3,  38 => 1,);
    }
...
{{ include ('micro_post/_post_list.html.twig', { posts: posts }) }}
{% endblock %}", "profile/show.html.twig", "/Users/josecorredor/jose/Symfony/social-media/templates/profile/show.html.twig");
    }
}
