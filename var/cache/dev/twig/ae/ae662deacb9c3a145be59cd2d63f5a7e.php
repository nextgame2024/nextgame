...
class __TwigTemplate_846044153297aa1341a77f5c8899036c extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 10
        yield "    ";
        yield Twig\Extension\CoreExtension::include($this->env, $context, "micro_post/_post.html.twig", ["post" => (isset($context["post"]) || array_key_exists("post", $context) ? $context["post"] : (function () { throw new RuntimeError('Variable "post" does not exist.', 10, $this->source); })())]);
        yield "
    ...
    <div>
        ";
        // line 16
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 16, $this->source); })()), "text", [], "any", false, false, false, 16), 'label', ["label_attr" => ["class" => "block text-sm text-gray-700 dark:text-gray-300 font-medium"], "label" => "Please enter the comment"]);
        yield "
        ";
        // line 17
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 17, $this->source); })()), "text", [], "any", false, false, false, 17), 'widget', ["attr" => ["class" => "block w-full shadow-sm border-gray-300 dark:border-transparent dark:text-gray-800 rounded-md border p-2 mt-1 mb-2"]]);
        yield "
        ";
        // line 18
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 18, $this->source); })()), "text", [], "any", false, false, false, 18), 'errors');
        yield "
    </div>
    
    <div>
        <button type=\"submit\" class=\"block w-full shadow-sm border-transparent bg-indigo-600 hover:bg-indigo-700 dark:bg-indigo-500 dark:hover:bg-indigo-400 text-white rounded-md border p-2 mt-4 mb-2\">Add comment</button>
    </div>
    ";
        // line 24
...
";
    ...
    {
        return array (  148 => 24,  139 => 18,  135 => 17,  131 => 16,  125 => 13,  121 => 12,  115 => 10,  105 => 9,  91 => 6,  81 => 5,  61 => 3,  38 => 1,);
    }
...
{% block body %}
    ...
    {{ form_end(form) }}
{% endblock %}
", "micro_post/comment.html.twig", "/Users/josecorredor/jose/Symfony/social-media/templates/micro_post/comment.html.twig");
    }
}
